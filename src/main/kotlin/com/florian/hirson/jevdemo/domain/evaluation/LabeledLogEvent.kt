...
data class LabeledLogEvent(val logEvent: LogEvent, val expectedCategory: Category) {
    ...
    /** Whether [classification] matched this event's ground truth. */
    fun isCorrectlyClassifiedBy(classification: Classification): Boolean = classification.category == expectedCategory
}
